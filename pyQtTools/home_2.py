...
class Home(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("#home_win{border-image:url(./picture/background1.png);}"
                           "QPushButton{color:rgb(0,240,244)}"
                           "QPushButton:hover{color:rgb(254,220,221)}"
                           "QPushButton{border:2px solid rgb(216,89,134)}"
                           "QPushButton{background-color:rgb(98,46,86);}"
                           ...
                           "QTextBrowser{color:rgb(195,5,150)}"
                           "QTextBrowser{background-color: rgb(63,39,52);}"
                           "QTextBrowser{border:2px solid rgb(15,123,127) round 1}"
                           )
        ...
        self.title_label.setStyleSheet("QLabel{background-color: rgb(187,120,206)}")
    ...
    def home_page(self):
        ...
        self.frame.setStyleSheet("QFrame{background-color:rgba(127,99,184,200)}")
        ...
        self.frame1.setStyleSheet("QFrame{background-color:rgba(127,99,184,200)}")

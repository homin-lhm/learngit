...
class Home(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("#home_win{border-image:url(./picture/background2.png);}"
                           "QPushButton{color:rgb(68,166,116)}"
                           "QPushButton:hover{color:rgb(209,232,222)}"
                           "QPushButton{border:2px solid rgb(55,100,82)}"
                           ...
                           "QLineEdit{background-color:rgb(7,17,16)}"
                           "QLineEdit{border:2px solid rgb(55,100,82)}"
                           "QTextBrowser{font:75 15pt '黑体'}"
                           "QTextBrowser{color:rgb(190,233,214)}"
                           "QTextBrowser{background-color: rgb(8,49,35);}"
                           "QTextBrowser{border:2px solid rgb(2,24,18) round 1}"
                           )
        ...
        self.title_label.setStyleSheet("QLabel{background-color: rgb(7,17,16)}"
    ...
    def home_page(self):
        ...
        self.frame.setStyleSheet("QFrame{border:2px solid rgb(10,20,18)}")
        ...
        self.frame1.setStyleSheet("QFrame{border:2px solid rgb(10,20,18)}")
